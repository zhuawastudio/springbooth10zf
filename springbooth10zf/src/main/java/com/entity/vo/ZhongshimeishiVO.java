...
public class ZhongshimeishiVO  implements Serializable {
	...
	public void setMeishideyoulai(String meishideyoulai) {
		this.meishideyoulai = meishideyoulai;
	}
	
	/**
	 * 获取：美食的由来
	 */
	public String getMeishideyoulai() {
		return meishideyoulai;
	}
